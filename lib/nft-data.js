...
export function generateNFTMetadata(tokenId) {
  ...
  if (tokenId === 9989) {
    return {
      ...
      external_url: 'https://genesiscollection.preview.emergentagent.com',
      attributes: [
        {
...
// Mint price in USD (configurable via environment variable)
export const MINT_PRICE_USD = parseFloat(process.env.NEXT_PUBLIC_MINT_PRICE_USD) || 85;
...
export const COLLECTION_INFO = {
  ...
  mintPriceDisplay: `$${MINT_PRICE_USD} USD`,
