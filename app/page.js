        ...
        {activeTab === 'home' && (
          <div className="container mx-auto px-4">
            ...
            <div 
              ...
              style={{
                backgroundImage: `url('https://customer-assets.emergentagent.com/job_genesishq-web3/artifacts/v0qbxc9z_grok_image_v5l8yd.jpg')`,
                  ...
                  <div className="grid md:grid-cols-2 gap-0">
                    ...
                    <div className="p-8">
                      ...
                      <div className="space-y-3 mb-6">
                        ...
                        <div className="flex justify-between">
                          <span className="text-amber-100/60">Leonardo Exclusives</span>
                          <span className="text-amber-400 font-semibold">10 (Ultra-Rare)</span>
                        </div>
                        <div className="flex justify-between">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <Card className="bg-slate-900/50 border-amber-900/30">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex justify-between border-b border-amber-900/20 pb-2">
                        <span className="text-amber-100/60">Total Supply</span>
                        <span className="text-amber-100 font-semibold">1,000,000,000 CAX</span>
                      </div>
                      <div className="flex justify-between border-b border-amber-900/20 pb-2">
                        <span className="text-amber-100/60">Circulating</span>
                        <span className="text-amber-100 font-semibold">250,000,000 CAX</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-amber-100/60">Market Cap</span>
                        <span className="text-amber-100 font-semibold">&#36;5.2M</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-slate-900/50 border-amber-900/30">
                  ...
                  <CardContent>
                    <ul className="space-y-2 text-amber-100/70">
                      ...
                      <li className="flex items-start">
                        <span className="text-emerald-400 mr-2">✓</span>
                        <span>Enhanced staking rewards (up to 25% APY)</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-emerald-400 mr-2">✓</span>
                      ...
                      <li className="flex items-start">
                        <span className="text-emerald-400 mr-2">✓</span>
                        <span>Priority in NFT drops and airdrops</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
              ...
              <Card className="bg-gradient-to-br from-amber-900/20 to-slate-900/50 border-amber-600/30">
                <CardHeader>
                  <CardTitle className="text-2xl text-amber-300">Staking Rewards</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="text-center p-6 bg-slate-900/50 rounded-lg">
                      <div className="text-3xl font-bold text-amber-400 mb-2">15% APY</div>
                      <div className="text-amber-100/60">Base Staking</div>
                    </div>
                    <div className="text-center p-6 bg-slate-900/50 rounded-lg">
                      <div className="text-3xl font-bold text-amber-400 mb-2">20% APY</div>
                      <div className="text-amber-100/60">With NFT Holder</div>
                    </div>
                    <div className="text-center p-6 bg-slate-900/50 rounded-lg">
                      <div className="text-3xl font-bold text-amber-400 mb-2">25% APY</div>
                      <div className="text-amber-100/60">G Lounge Members</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
