...
async function prepareTransactionRequest(client, args) {
    ...
    const attemptFill = exports.supportsFillTransaction.get(client.uid) !== false &&
        ['fees', 'gas'].some((parameter) => args.parameters?.includes(parameter));
    const fillResult = attemptFill
        ? await (0, getAction_js_1.getAction)(client, fillTransaction_js_1.fillTransaction, 'fillTransaction')({ ...args, nonce })
            .then((result) => {
